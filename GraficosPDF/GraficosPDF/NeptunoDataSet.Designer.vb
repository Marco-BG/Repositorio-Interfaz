...
Namespace NeptunoDataSetTableAdapters
    ...
    Partial Public Class CategoríasTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.GraficosPDF.My.MySettings.Default.NeptunoConnectionString
        End Sub
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        IdProducto, NombreProducto, IdProveedor, IdCategoría, CantidadPorUn"& _ 
                "idad, PrecioUnidad, UnidadesEnExistencia, UnidadesEnPedido, NivelNuevoPedido, Su"& _ 
                "spendido"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Productos"
        ...
        Public Overloads Overridable Function FillByTodosProductos(ByVal dataTable As NeptunoDataSet.ProductosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataByTodosProductos() As NeptunoDataSet.ProductosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As NeptunoDataSet.ProductosDataTable = New NeptunoDataSet.ProductosDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
