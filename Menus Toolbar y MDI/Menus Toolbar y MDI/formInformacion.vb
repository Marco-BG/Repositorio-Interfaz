Public NotInheritable Class formInformacion

    Private Sub formInformacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
